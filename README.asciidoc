...
image::keycloak-cli-client-example/img/keycloak-admin.png[]
...
image::keycloak-cli-client-example/img/cli-client.png[]
...
image::keycloak-cli-client-example/img/authorization-code-flow.png[]
